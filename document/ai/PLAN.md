...
> 焦点 → Phase 2 批5c `sh` 深化续：here-doc + read增强/break N/高级`${}`/trap（算术/case/函数已完成）。
...
| 批5c | `sh` 深化 — ✅算术 `$((expr))`/case/函数+return+local（40d48dc·181eaa9·bfcc71e）；⏳here-doc/read增强/break N/高级`${}`/trap | 🔄 | — | 436/41 |
