...
> 焦点 → Phase 2 批5c `sh` 深化尾：trap（信号处理，下回合 fresh context）；算术/case/函数/here-doc/高级`${}`/break N/read 增强已全收。
...
| 批5c | `sh` 深化 — ✅算术/case/函数+return+local/here-doc/高级`${}`/break N/read增强（40d48dc·181eaa9·bfcc71e·e07de18·f23c2f1·4e5814f·33bc74f）；⏳trap | 🔄 | — | 436/55 |
